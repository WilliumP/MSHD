...
public interface CishengzaihaiQitaDao {
    ...
    void Insert(@Param("cr") CishengzaihaiQita cr);

    @Select("select * from cishengzaihaiqita ORDER BY `key` ASC")
    List<CishengzaihaiQita> selectAll();

    @Select("select * from cishengzaihaiqita where type = #{type}")
    List<CishengzaihaiQita> selectByType(@Param("type") String type);

    @Select("select * from cishengzaihaiqita where reporting_unit = #{reporting_unit}")
    List<CishengzaihaiQita> selectByUnit(@Param("reporting_unit") String reporting_unit);
    
    @Select("select * from cishengzaihaiqita where `key` = #{key}")
    List<CishengzaihaiQita> selectByKey(@Param("key") String key);
    ...
    boolean insertForeach(@Param(value = "list") List<CishengzaihaiQita> list);
    ...
    boolean beifen(@Param(value = "list") List<CishengzaihaiQita> list);
    ...
    void updateByKey(@Param("cr") CishengzaihaiQita cr);
}
